...
public class PanelUtilisateur extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        txtProfil = new javax.swing.JComboBox<>();
        ...
        tb_User = new classe_special.Tableaux();
        ...
        txtProfil.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Administrateur", "Utilisateur" }));
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtProfil, javax.swing.GroupLayout.PREFERRED_SIZE, 196, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(txtProfil, javax.swing.GroupLayout.DEFAULT_SIZE, 43, Short.MAX_VALUE)
        ...
        tb_User.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "idUser", "Login", "Profil", "Nom Employé"
            }
        ));
        ...
        if (index==-1){
            ...
            new Confirm().affiche("Supprimer","Etes vous sur de vouloir Supprimer!!!", new ActionListener() {
                ...
                public void actionPerformed(ActionEvent ae) {
                    int index = tb_User.getSelectedRow();
                    int id = (int)tb_User.getValueAt(index,0);
    ...
    private void btnEnregistrerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEnregistrerActionPerformed
        ...
        String profil=txtProfil.getSelectedItem().toString();
        ...
        if(login.equals("")||password.equals("")){
            ...
            User u=new User(login, password, profil, idEmploye);
            udao.inserer(u);
            vider();liste();
            frameAjouter.setVisible(false);
        }
        else if(modifier==true){
            int ligne=tb_User.getSelectedRow();
            int idUser =(int)tb_User.getValueAt(ligne, 0);
            User u=new User(login, password, profil, idEmploye);
    ...
    private void tb_UserMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tb_UserMouseClicked
        ...
        if(index!=-1){
            int id = (int)tb_User.getValueAt(index,0);
            UserDAO udao=new UserDAO();
            User u=udao.rechercher(id);
            txtLogin.setText(u.getLogin());
            txtPassword.setText(u.getPassword());
            txtProfil.setSelectedItem(u.getProfil());
    ...
    private classe_special.Tableaux tb_User;
    private javax.swing.JComboBox<String> txtEmploye;
    private javax.swing.JTextField txtLogin;
    private javax.swing.JTextField txtPassword;
    private javax.swing.JComboBox<String> txtProfil;
    // End of variables declaration//GEN-END:variables

public void liste(){
    UserDAO udao = new UserDAO();
    EmployeDAO edao=new EmployeDAO();
        List<User> user = udao.liste();
        
        for (int i = 0; i < user.size(); i++) {
            Employe em=edao.rechercher(user.get(i).getIdEmploye());
            String nom=em.getNom()+" "+em.getPrenom();
            ((DefaultTableModel) tb_User.getModel()).addRow(new Object[]{
                  user.get(i).getIdUser(),
                  user.get(i).getLogin(),
                  user.get(i).getProfil(),
                  nom
            });
