 ...
 * @author fofana
 */
public class PanelEntretient extends javax.swing.JPanel {
 
    boolean modifier;
    /**
     * Creates new form PanelUtilisateur
     */
    public PanelEntretient() {
        initComponents();
        liste();
        combo();
    }
    ...
    private void initComponents() {
        ...
        tb_Entretient = new classe_special.Tableaux();
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtCandidat, javax.swing.GroupLayout.PREFERRED_SIZE, 196, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(txtCandidat, javax.swing.GroupLayout.DEFAULT_SIZE, 43, Short.MAX_VALUE)
        ...
        tb_Entretient.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "idEntretient", "Date", "Intervieweur", "Note Candidat", "Candidat"
            }
        ));
        tb_Entretient.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tb_EntretientMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tb_Entretient);
        ...
        jLabel6.setText("Gestion des Entretients");
    ...
    private void btnModifier1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnModifier1MouseClicked
        int index = tb_Entretient.getSelectedRow();
        if (index==-1){
            JOptionPane.showMessageDialog(this,"Veuillez selectionnez une ligne");
        }
        else {
            jLabel5.setText("Modifier Entretient");
        ...
        if (index==-1){
            ...
            new Confirm().affiche("Supprimer","Etes vous sur de vouloir Supprimer!!!", new ActionListener() {
                ...
                public void actionPerformed(ActionEvent ae) {
                    int index = tb_Entretient.getSelectedRow();
                    int id = (int)tb_Entretient.getValueAt(index,0);
                    EntretientDAO udao = new EntretientDAO();
                    udao.supprimer(id);
                    vider();
                    liste();
                }
    ...
    private void btnEnregistrerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEnregistrerActionPerformed
        ...
        String profil=txtCandidat.getSelectedItem().toString();
        int indexc=profil.indexOf(" ");
        String idc=profil.substring(0, indexc);
        ...
        if(modifier==false){
            Entretient u=new Entretient(idEmploye, note, idCandidat);
            udao.inserer(u);
            vider();liste();
            frameAjouter.setVisible(false);
        }
        else if(modifier==true){
            int ligne=tb_Entretient.getSelectedRow();
            int idUser =(int)tb_Entretient.getValueAt(ligne, 0);
            Entretient u=new Entretient(idEmploye, note, idCandidat);
    ...
    private void tb_EntretientMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tb_EntretientMouseClicked
        int index = tb_Entretient.getSelectedRow();
        if(index!=-1){
            int id = (int)tb_Entretient.getValueAt(index,0);
            EntretientDAO udao=new EntretientDAO();
            Entretient u=udao.rechercher(id);
            txtNote.setText(u.getNoteCandidat()+"");
            
            CandidatDAO cdao = new CandidatDAO();
            Candidat candidat = cdao.rechercher(u.getCandidat());
            String cand=candidat.getIdCandidat()+" "+candidat.getNom()+" "+candidat.getPrenom();
            txtCandidat.setSelectedItem(cand);
            
            EmployeDAO edao = new EmployeDAO();
            Employe employe = edao.rechercher(u.getIntervieweur());
            String emp=employe.getIdEmploye()+" "+employe.getNom()+" "+employe.getPrenom();
            txtEmploye.setSelectedItem(emp);
        }
    }//GEN-LAST:event_tb_EntretientMouseClicked
    ...
    private classe_special.Tableaux tb_Entretient;
...
public void liste(){
    ...
    EmployeDAO edao=new EmployeDAO();
    CandidatDAO cdao=new CandidatDAO();
        List<Entretient> user = udao.liste();
        
        for (int i = 0; i < user.size(); i++) {
            Employe em=edao.rechercher(user.get(i).getIntervieweur());
            String nomEmp=em.getNom()+" "+em.getPrenom();
            
            Candidat cand=cdao.rechercher(user.get(i).getCandidat());
            String nomCand=cand.getNom()+" "+cand.getPrenom();
            
            ((DefaultTableModel) tb_Entretient.getModel()).addRow(new Object[]{
                  user.get(i).getIdEntretient(),
                  user.get(i).getDateEntretient(),
                  nomEmp,
                  user.get(i).getNoteCandidat(),
                  nomCand
            });
...
public void vider(){
        txtNote.setText("");
        DefaultTableModel model = (DefaultTableModel) tb_Entretient.getModel();
...
public void combo(){
    ...
    CandidatDAO cdao=new CandidatDAO();
    List<Candidat> cand=cdao.liste();
    for (int i = 0; i < cand.size(); i++){
        String cat=cand.get(i).getIdCandidat()+" "+cand.get(i).getNom()+" "+cand.get(i).getPrenom();
        txtCandidat.addItem(cat);
    }
}
